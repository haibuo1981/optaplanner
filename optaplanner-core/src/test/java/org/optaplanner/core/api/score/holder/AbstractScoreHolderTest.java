...
public abstract class AbstractScoreHolderTest {
    ...
    protected <Score_ extends Score<Score_>> ConstraintMatchTotal<Score_> findConstraintMatchTotal(
            ScoreHolder<Score_> scoreHolder, String ruleName) {
        Collection<ConstraintMatchTotal<Score_>> constraintMatchTotals = scoreHolder.getConstraintMatchTotals();
        Optional<ConstraintMatchTotal<Score_>> first = constraintMatchTotals.stream()
                .filter(constraintMatchTotal -> constraintMatchTotal.getConstraintName().equals(ruleName))
                .findFirst();
