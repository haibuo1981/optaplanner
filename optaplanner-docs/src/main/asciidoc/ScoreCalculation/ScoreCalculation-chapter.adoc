...
[source,java,options="nowrap"]
----
Collection<ConstraintMatchTotal<HardSoftScore>> constraintMatchTotals = guiScoreDirector.getConstraintMatchTotals();
...
[source,java,options="nowrap"]
----
Map<Object, Indictment<HardSoftScore>> indictmentMap = guiScoreDirector.getIndictmentMap();
