...
<#list ["NONE", "1", "2", "4", "8", "16", "32", "48"] as moveThreadCount>
  <solverBenchmark>
    <name>Tabu Search ${moveThreadCount}-threads</name>
    <solver>
      <moveThreadCount>${moveThreadCount}</moveThreadCount>
  ...
  <solverBenchmark>
    <name>Late Acceptance ${moveThreadCount}-threads</name>
    <solver>
      <moveThreadCount>${moveThreadCount}</moveThreadCount>
      <constructionHeuristic>
        <constructionHeuristicType>FIRST_FIT_DECREASING</constructionHeuristicType>
  ...
  <solverBenchmark>
    <name>Tabu Search ${moveThreadCount}-threads Nearby</name>
    <solver>
      <moveThreadCount>${moveThreadCount}</moveThreadCount>
      <constructionHeuristic>
        <constructionHeuristicType>FIRST_FIT_DECREASING</constructionHeuristicType>
  ...
  <solverBenchmark>
    <name>Late Acceptance ${moveThreadCount}-threads Nearby</name>
    <solver>
      <moveThreadCount>${moveThreadCount}</moveThreadCount>
      <constructionHeuristic>
        <constructionHeuristicType>FIRST_FIT_DECREASING</constructionHeuristicType>
